                ...
                if (res.data.success) {
                    if (res.data.data.readWrite === "写") {
                        ...
                        if (GOJS.thisNode.enums_value) {
                            ...
                            GOJS.thisNode.value !== null &&
                            GOJS.thisNode.value !== undefined
                        ) {
                            vm.form.value = GOJS.thisNode.value;
                        } else if (
                            GOJS.thisNode.vname !== null &&
                            GOJS.thisNode.vname !== undefined
                        ) {
                            vm.form.value = GOJS.thisNode.vname;
                        } else if (
                            GOJS.thisNode.nname !== null &&
                            GOJS.thisNode.nname !== undefined
                        ) {
                            vm.form.value = GOJS.thisNode.nname;
                        } else if (
                            GOJS.thisNode.name !== null &&
                            GOJS.thisNode.name !== undefined
                        ) {
